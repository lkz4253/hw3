function pageLoad() {
  ...
  // display of single passenger for ride length of 1
  ...
  if (ride.length == 1) {
    ...
    // display of both passengers for ride length of 2
    ...
    // display of all three passengers for ride length of 3
